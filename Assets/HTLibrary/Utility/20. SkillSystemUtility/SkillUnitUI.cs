...
namespace HTLibrary.Utility
{
    public class SkillUnitUI : MonoBehaviour
    {
        ...
        public void SetSkillUnit(SkillUnit skillUnit)
        {
            ...
            if(useConfigure)
            {
                AddressableUtility.Instance.LoadAddressableObject<Sprite>(skillUnit.iconRef, FinisheLoadedSprite);
            }
            else
            {
                //TODO
        ...
        void FinisheLoadedSprite(AsyncOperationHandle<Sprite> result)
        {
            iconImage.sprite = result.Result;
        }
